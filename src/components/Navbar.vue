<template>
  <header class="bg-white shadow h-16 flex justify-between items-stretch">
    <router-link :to="{name:'home'}" class="inline-flex items-center h-full hover:bg-purple-100 px-5">
      Home 
    </router-link>
    <div class="flex items-center gap-2">
      ...
      <router-link :to="{name:'favorites'}" class="inline-flex items-center px-2 h-full transition-colors hover:bg-purple-100">
        Favorites ❤️
      </router-link>
    </div>
  </header>
